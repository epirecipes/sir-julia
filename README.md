...
- [Ordinary differential equation using Petri nets from AlgebraicPetri.jl](https://github.com/epirecipes/sir-julia/blob/master/markdown/ode_algebraicpetri/ode_algebraicpetri.md)
...
- [Stochastic differential equation using Petri nets from AlgebraicPetri.jl](https://github.com/epirecipes/sir-julia/blob/master/markdown/sde_algebraicpetri/sde_algebraicpetri.md)
...
- [Jump process (Gillespie) using Petri nets from AlgebraicPetri.jl](https://github.com/epirecipes/sir-julia/blob/master/markdown/jump_process_algebraicpetri/jump_process_algebraicpetri.md)
