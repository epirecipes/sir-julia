...
LabelledArrays.LArray{Float64,1,Array{Float64,1},(:S, :I, :R)},Tuple{Float6
4,Float64},true,LabelledArrays.LArray{Float64,1,Array{Float64,1},(:inf, :re
c)},Nothing,DiffEqBase.SDEFunction{true,Petri.var"#f#3"{Array{Symbol,1},Lab
elledArrays.LArray{Tuple{LabelledArrays.LArray{Int64,1,Array{Int64,1},Syms}
 where Syms,LabelledArrays.LArray{Int64,1,Array{Int64,1},Syms} where Syms},
1,Array{Tuple{LabelledArrays.LArray{Int64,1,Array{Int64,1},Syms} where Syms
,LabelledArrays.LArray{Int64,1,Array{Int64,1},Syms} where Syms},1},(:inf, :
rec)},Dict{Any,Any}},Petri.var"#noise#12"{LabelledArrays.LArray{Tuple{Label
ledArrays.LArray{Int64,1,Array{Int64,1},Syms} where Syms,LabelledArrays.LAr
ray{Int64,1,Array{Int64,1},Syms} where Syms},1,Array{Tuple{LabelledArrays.L
Array{Int64,1,Array{Int64,1},Syms} where Syms,LabelledArrays.LArray{Int64,1
,Array{Int64,1},Syms} where Syms},1},(:inf, :rec)},Dict{Any,Any},Dict{Symbo
l,Int64},Dict{Symbol,Int64}},LinearAlgebra.UniformScaling{Bool},Nothing,Not
hing,Nothing,Nothing,Nothing,Nothing,Nothing,Nothing,Nothing,Nothing,Nothin
g,Nothing,Nothing},Petri.var"#noise#12"{LabelledArrays.LArray{Tuple{Labelle
dArrays.LArray{Int64,1,Array{Int64,1},Syms} where Syms,LabelledArrays.LArra
y{Int64,1,Array{Int64,1},Syms} where Syms},1,Array{Tuple{LabelledArrays.LAr
ray{Int64,1,Array{Int64,1},Syms} where Syms,LabelledArrays.LArray{Int64,1,A
rray{Int64,1},Syms} where Syms},1},(:inf, :rec)},Dict{Any,Any},Dict{Symbol,
Int64},Dict{Symbol,Int64}},Base.Iterators.Pairs{Union{},Union{},Tuple{},Nam
edTuple{(),Tuple{}}},SparseArrays.SparseMatrixCSC{Float64,Int64}},DiffEqBas
e.CallbackSet{Tuple{DiffEqBase.ContinuousCallback{Petri.var"#4#6"{Symbol},P
etri.var"#5#7"{Symbol},Petri.var"#5#7"{Symbol},typeof(DiffEqBase.INITIALIZE
_DEFAULT),Float64,Int64,Nothing,Int64},DiffEqBase.ContinuousCallback{Petri.
var"#4#6"{Symbol},Petri.var"#5#7"{Symbol},Petri.var"#5#7"{Symbol},typeof(Di
ffEqBase.INITIALIZE_DEFAULT),Float64,Int64,Nothing,Int64},DiffEqBase.Contin
uousCallback{Petri.var"#4#6"{Symbol},Petri.var"#5#7"{Symbol},Petri.var"#5#7
"{Symbol},typeof(DiffEqBase.INITIALIZE_DEFAULT),Float64,Int64,Nothing,Int64
}},Tuple{}}}, ::StochasticDiffEq.LambaEM{true})
